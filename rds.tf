...
resource "aws_rds_cluster" "rds" {
  ...
  master_password                 = random_id.rds.b64 #var.master_password #random_id.rds_password.b64_std #data.aws_secretsmanager_secret_version.my_secret_rds_user_map.secret_id
